var insteurope_CRE = [
  ...
  {
    "id": "insteurope_cre_006",
    "theme": "insteurope",
    "level": "CRE",
    "type": "single",
    "question": "De quelle couleur est le drapeau européen ?",
    "answers": [
      { "id": "blo", "label": "bleu avec des étoiles d'or" },
      { "id": "blr", "label": "bleu avec des étoiles rouges" },
      { "id": "jab", "label": "jaune avec des étoiles bleues" },
      { "id": "bbr", "label": "bleu, blanc, rouge" },
      { "id": "roo", "label": "rouge avec une étoile d'or" }
      ],
    "correct": ["blo"],
    "explanation": "Le drapeau européen est composé de 12 étoiles d'or sur un fond bleu. Il a été choisi comme emblème en 1955."
  },
  {
    "id": "insteurope_cre_007",
    "theme": "insteurope",
    "level": "CRE",
    "type": "single",
