let geographie_VID = [
  {
    ...
    "level": "VID",
    "type": "single",
    "question": "La France métropolitaine a la forme d'un :",
    "answers": [
      { "id": "hexa", "label": "hexagone" },
      { "id": "carr", "label": "carré" },
      { "id": "tria", "label": "triangle" },
      { "id": "visa", "label": "visage" },
      { "id": "topi", "label": "topinambour" },
      { "id": "dode", "label": "dodécagone" }
    ],
    "correct": ["hexa"],
    "explanation": "La forme simplifiée de la France métropolitaine est celle d'une figure géométrique à six côtés, un hexagone."
  },
  {
    "id": "geographie_vid_002",
    "theme": "geographie",
    "level": "VID",
    "type": "single",
    "question": "Du nord au sud, la France métropolitaine mesure :",
    "answers": [
      { "id": "mil", "label": "1000 kilomètres" },
      { "id": "cen", "label": "100 kilomètres" },
  ...
  {
    "id": "geographie_vid_003",
    "theme": "geographie",
    "level": "VID",
    "type": "single",
    "question": "D'est en ouest, la France métropolitaine mesure :",
    "answers": [
      { "id": "mil", "label": "1000 kilomètres" },
      { "id": "cen", "label": "100 kilomètres" },
      { "id": "dem", "label": "2000 kilomètres" },
  ...
  {
    "id": "geographie_vid_004",
    "theme": "geographie",
    "level": "CSP",
    "type": "multi",
    "question": "Quel fleuve coule entièrement en France ?",
    "answers": [
  ...
  {
    "id": "geographie_vid_005",
    "theme": "geographie",
    "level": "VID",
    "type": "multi",
    "question": "Quel pays a une frontière terrestre commune avec la France métropolitaine ?",
    "answers": [
  ...
  },
  {
    ...
    "level": "VID",
    "type": "multi",
    "question": "Quel petit état a une frontière commune avec la France ?",
    "answers": [
      { "id": "and", "label": "Andorre" },
      { "id": "lux", "label": "Luxembourg" },
      { "id": "mon", "label": "Monaco" },
      { "id": "sam", "label": "San-Marin" },
      { "id": "vat", "label": "Le Vatican" },
      { "id": "mal", "label": "Malte" },
  ...
  },
  {
    ...
    "level": "VID",
    "type": "multi",
    "question": "Quel lieu touristique est en France ?",
    "answers": [
      { "id": "eif", "label": "La tour Eiffel" },
      { "id": "sami", "label": "Le Mont-Saint-Michel " },
      { "id": "stli", "label": "La statue de la Liberté" },
      { "id": "pouc", "label": "Le musée Pouchkine" },
      { "id": "sans", "label": "Le palais de Sanssouci" },
      { "id": "angk", "label": "Le temple d'Angkor" },
      { "id": "cord", "label": "La mosquée de Cordoue" },
      { "id": "colo", "label": "La cathédrale de Cologne" }
    ],
    "correct": ["eif","sami"],
    "explanation": "Les trois sites touristiques les plus visités en France sont la tour Eiffel, le château de Versailles et le Mont-Saint-Michel."
  },
  {
    "id": "geographie_vid_008",
    "theme": "geographie",
    "level": "CSP",
    "type": "multi",
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "nord", "label": "Mer du Nord" },
      { "id": "sargasses", "label": "Mer des Sargasses" },
      { "id": "aral", "label": "Mer d'Aral" },
      { "id": "noire", "label": "Mer Noire" },
      { "id": "adriatique", "label": "Mer Adriatique" },
      { "id": "caspienne", "label": "Mer Caspienne" }
    ],
  ...
  },
  {
    ...
    "explanation": "Marseille, Toulon, Nice, sont les villes les plus importantes au bord de la mer Méditerranée. Montpellier, Béziers, Narbonne, Perpignan sont proches de la côte, mais pas en bord de mer. Dunkerque, Le Havre, La Rochelle, Bordeaux, sont des ports de l'océan Atlantique."
  },
  {
    "id": "geographie_vid_018",
    "theme": "geographie",
    "level": "CSP",
    "type": "single",
