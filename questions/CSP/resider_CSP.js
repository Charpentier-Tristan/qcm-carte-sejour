let resider_CSP = [
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "ess", "label": "Faire le plein d'essence" },
      { "id": "met", "label": "Consulter la météo" },
      { "id": "gps", "label": "Régler son GPS" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "rel", "label": "Il doit être célébré dans un édifice religieux" },
      { "id": "eng", "label": "Il faut remplir un formulaire d'engagement" },
      { "id": "par", "label": "Il doit être accompagné du consentement des parents" },
