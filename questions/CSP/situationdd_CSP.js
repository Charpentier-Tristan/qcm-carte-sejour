let situationdd_CSP = [
  {
    ...
    "answers": [
      ...
      { "id": "con", "label": "la liberté contractuelle" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "lib", "label": "de la liberté du commerce et de l'industrie" },
      { "id": "sou", "label": "de la souveraineté nationale en matière de sécurité" },
      { "id": "opi", "label": "de la liberté d'opinion, garantie par la Déclaration des droits de l'homme de 1789" }
    ],
    "correct": ["pri"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "com", "label": "illégale, car l'exercice commun de l'autorité parentale implique l'accord des deux parents pour un changement de nom" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "res", "label": "Oui, toute ressource du foyer doit être déclarée" },
      { "id": "fra", "label": "Oui, car la fraude aux prestations sociales est un délit" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "spo", "label": "interdite, car les sportifs représentant la Nation doivent observer une stricte neutralité politique" },
      { "id": "arg", "label": "autorisée, à condition qu'il ne reçoive pas d'argent du candidat" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "lib", "label": "Ses propos sont protégés par la liberté académique" },
      { "id": "vio", "label": "Seuls les propos incitant directement à la violence sont punissables" },
      { "id": "tro", "label": "Elle ne peut être poursuivie que si ses propos ont causé un trouble à l'ordre public" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "cli", "label": "légale, uniquement si l'entreprise a des relations avec la clientèle" },
      { "id": "mai", "label": "illégale, uniquement si le salarié ne maîtrise pas le français" },
      { "id": "com", "label": "légale, car le patron doit comprendre ce que se disent ses employés" }
    ],
    "correct": ["jus"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "sou", "label": "Non, la protection des sources ne s'applique pas aux secrets de la défense nationale" },
      { "id": "rev", "label": "Oui, à condition qu'il démontre l'intérêt public supérieur de la révélation" },
      { "id": "abs", "label": "Oui, la liberté de la presse est absolue en matière d'investigation" },
      { "id": "pre", "label": "Oui, sous réserve de montrer l'article au Préfet avant publication" }
    ],
    "correct": ["rep"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "lib", "label": "de la libre administration de la commune" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "fin", "label": "interdire cet enseignement seulement s'il est financé par des fonds publics" },
      { "id": "lib", "label": "laisser faire, au nom de la liberté pédagogique de l'enseignant" },
  ...
  },
  {
    ...
    { "id": "lib", "label": "illégal car il établit une interdiction générale et absolue, disproportionnée au regard de la liberté de manifestation" },
      { "id": "mai", "label": "légal, car le maire est responsable de l'ordre public local" },
      { "id": "pre", "label": "légal, si le préfet l'a approuvé" },
      { "id": "int", "label": "illégal, car seul le préfet peut interdire une manifestation" },
      { "id": "com", "label": "légal car les commerçants versent à la commune une contribution foncière" }
      ],
    "correct": ["lib"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "pay", "label": "légale si la personne accepte de payer une contrepartie" }
      ],
    "correct": ["rec"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "fin", "label": "légale, et elle s'accompagne d'une contribution financière du salarié" }
      ],
    "correct": ["cir"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "tem", "label": "Oui, le devoir de témoigner en justice prime toujours" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "ina", "label": "Oui, l'inaptitude médicale est une cause réelle et sérieuse de licenciement" },
      { "id": "ind", "label": "Oui, si l'employeur paie une indemnité de licenciement majorée" },
      { "id": "dis", "label": "Non, car le licenciement d'une personne handicapée est toujours discriminatoire" },
      { "id": "pou", "label": "Oui, car le patron a tout pouvoir pour licencier" }
      ],
    "correct": ["rec"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "pri", "label": "Une prise illégale d'intérêt" }
    ],
    "correct": ["con"],
