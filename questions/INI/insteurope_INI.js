let insteurope_INI = [
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "rus", "label": "Russie" },
      { "id": "bul", "label": "France" },
      { "id": "mal", "label": "Allemagne" },
      { "id": "est", "label": "Espagne" },
      { "id": "vaq", "label": "Italie" },
      { "id": "ven", "label": "Pays-Bas" },
      { "id": "fin", "label": "Portugal" },
      { "id": "let", "label": "Suède" }
      ],
    "correct": ["sui","rus"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "age", "label": "savoir conduire" },
      { "id": "con", "label": "habiter en Europe" },
      { "id": "mon", "label": "être un homme" },
      { "id": "dip", "label": "être diplômé" }
      ],
    "correct": ["pay"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "six", "label": "Tous les seize ans" },
      { "id": "sep", "label": "Tous les vingt ans" },
      { "id": "tro", "label": "Tous les cent ans" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "ita", "label": "Italie" },
      { "id": "bel", "label": "Zimbabwe" },
      { "id": "royu", "label": "Rwanda" },
      { "id": "sue", "label": "Argentine" },
      { "id": "esp", "label": "Russie" },
      { "id": "por", "label": "Vietnam" },
      { "id": "gre", "label": "Chine" },
      { "id": "aut", "label": "Laos" },
      { "id": "lit", "label": "Mongolie" }
    ],
  ...
  },
  {
    ...
    "answers": [
      { "id": "eur", "label": "L'euro" },
      { "id": "fra", "label": "La peseta" },
      { "id": "ecu", "label": "Le rouble" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "hab", "label": "Les habitants de l'Europe" },
      { "id": "fra", "label": "Tous les français" },
      { "id": "par", "label": "Seulement les hommes" },
      { "id": "min", "label": "Seulement les riches" }
      ],
    "correct": ["cit"],
    "explanation": "Les élections européennes sont organisées tous les cinq ans. Les citoyens et les citoyennes de l'Union européenne votent pour désigner les membres du Parlement européen. On les appelle les députés européens, ou eurodéputés. Pour avoir le droit de voter en France lors des élections européennes, il faut avoir la nationalité d'un pays membre de l'Union européenne ; habiter en France ; avoir au moins 18 ans la veille du 1er tour de l'élection ; être inscrit sur les listes électorales françaises."
  },
  {
    "id": "insteurope_ini_008",
    "theme": "insteurope",
    "level": "INI",
    "type": "single",
    ...
    "answers": [
      ...
      { "id": "hum", "label": "Le 1er avril" },
      { "id": "dhj", "label": "Le 31 décembre" },
