var soins_CRE = [
  ...
  },
  {
    ...
    "answers": [
      { "id": "tou", "label": "À toutes et à tous" },
      { "id": "fem", "label": "Aux femmes" },
      { "id": "hom", "label": "Aux hommes" },
      { "id": "vis", "label": "Aux personnes de moins de 26 ans" },
      { "id": "qua", "label": "Aux personnes âgées de plus de 40 ans" }
      ],
    "correct": ["tou"],
