let laique_INI = [
  {
    ...
    "answers": [
      ...
      { "id": "pref", "label": "Seulement sur avis de l'imam" },
      { "id": "mai", "label": "Oui, si le maire le demande" },
      { "id": "pres", "label": "Seulement si le Président l'a ordonné" },
      { "id": "exp", "label": "Non, sauf si son église brûle" }
      ],
    "correct": ["tou"],
  ...
  },
  {
    ...
    "answers": [
      { "id": "lai", "label": "laïque" },
      { "id": "sol", "label": "solide" },
      { "id": "rel", "label": "catholique" },
      { "id": "jud", "label": "judicieuse" },
      { "id": "ega", "label": "égale" }
      ],
    "correct": ["lai"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "ass", "label": "la liberté de rigoler" },
      { "id": "exp", "label": "la liberté de circuler" },
      { "id": "man", "label": "la liberté de s'abonner à Tik Tok" },
      { "id": "cir", "label": "la liberté de respirer" }
      ],
    "correct": ["con"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "int", "label": "L'interdiction des religions" },
      { "id": "ath", "label": "Le triomphe de l'athéisme" },
      { "id": "eta", "label": "La religion d'État" },
      { "id": "opi", "label": "Le contrôle des opinions" },
      { "id": "con", "label": "Le pouvoir des moines" }
    ],
    "correct": ["sep"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "par", "label": "Oui, si un influenceur l'exige" },
      { "id": "aut", "label": "Oui, s'il l'annonce sur Tik Tok" },
      { "id": "pre", "label": "Seulement sur demande d'un imam" }
      ],
    "correct": ["fet"],
  ...
  },
  {
    ...
    "answers": [
      { "id": "tou", "label": "Oui, toujours et sans contrôle" },
      { "id": "pref", "label": "Seulement s'il l'annonce sur Tik Tok" },
      { "id": "pref", "label": "Seulement si un rabbin le décide" },
      { "id": "mai", "label": "Oui, si le maire le demande" },
      { "id": "pres", "label": "Oui, sur ordre du Président" },
      { "id": "exp", "label": "Non, sauf si son église brûle" }
      ],
    "correct": ["tou"],
    "explanation": "La laïcité garantit la liberté de conscience pour tous, c'est-à-dire que chaque personne est libre d'avoir ou de ne pas avoir de religion, d'en changer ou de ne plus en avoir."
