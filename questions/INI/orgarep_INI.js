var orgarep_INI = [
  {
    ...
    "answers": [
      ...
      { "id": "enr", "label": "ils s'enrichissent" },
      { "id": "pou", "label": "ils disent n'importe quoi" },
      { "id": "int", "label": "ils n'écoutent rien" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "eal", "label": "Expéditif, Admirable, Liminaire" },
      { "id": "eja", "label": "Lyrique, Audible, Épatant" },
      { "id": "lal", "label": "Légal, Extrême, Joyeux" },
      { "id": "lie", "label": "Ludique, Excessif, Jovial" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "pol", "label": "Le maire" },
      { "id": "ass", "label": "La maîtresse d'école" },
      { "id": "cri", "label": "L'influenceur" },
      { "id": "eur", "label": "Le chef d'orchestre" }
      ],
    "correct": ["cor"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "fra", "label": "Les Américains" },
      { "id": "sen", "label": "Les sénateurs" },
      { "id": "hom", "label": "Les Russes" },
      { "id": "con", "label": "Les Ministres" }
      ],
    "correct": ["cir"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "cac", "label": "Les milliardaires" },
      { "id": "bou", "label": "La Bourse" },
      { "id": "eur", "label": "Les Américains" },
      { "id": "pre", "label": "Les Russes" }
    ],
    "correct": ["dep"],
    "explanation": "Le pouvoir législatif est exercé par le Parlement, composé de deux chambres : l'Assemblée nationale (députés), et le Sénat (sénateurs). Ces deux assemblées sont chargées de voter la loi, de contrôler l'action du Gouvernement et d'évaluer les politiques publiques."
  },
  {
    ...
    "answers": [
      ...
      { "id": "pre", "label": "Madonna" },
      { "id": "sen", "label": "La Joconde" },
      { "id": "ass", "label": "Le patron de Tik Tok" },
      { "id": "cio", "label": "Mickey" }
      ],
    "correct": ["rep"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "dep", "label": "Madonna" },
      { "id": "sen", "label": "Un influenceur" },
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "for", "label": "Oui, bien sûr" },
      { "id": "gue", "label": "Il les aurait en temps de guerre" },
      { "id": "quo", "label": "Il a celui de s'enrichir" },
      { "id": "eco", "label": "Oui, jusqu'à 60 ans" }
      ],
    "correct": ["exe"],
  ...
  },
  {
    ...
    "answers": [
      ...
      { "id": "com", "label": "L'élu de la commune" },
      { "id": "con", "label": "Un influenceur" },
      { "id": "dep", "label": "Le patron de Tik Tok" },
      { "id": "sen", "label": "Un serveur chez MacDo" }
      ],
    "correct": ["rep"],
    "explanation": "Le Préfet est le représentant de l'État dans le département. Il dirige les services de l'État dans son département."
  },
  {
    ...
    "answers": [
      ...
      { "id": "pol", "label": "Se la couler douce" },
      { "id": "jug", "label": "Partir en vacances" },
      { "id": "ord", "label": "Tourner des vidéos Tik Tok" },
      { "id": "etr", "label": "S'enrichir" }
      ],
    "correct": ["loi"],
    "explanation": "Le pouvoir législatif est exercé par le Parlement, composé de deux chambres : l'Assemblée nationale (députés), et le Sénat (sénateurs). Ces deux assemblées sont chargées de voter la loi, de contrôler l'action du Gouvernement et d'évaluer les politiques publiques."
  },
